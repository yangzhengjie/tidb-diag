...
同一 Prometheus profile 即使包含多个指标模板，也只算一类观测。
...
诊断结论见 §1.1，观测源边界见 §1.1 和 §1.4，官方问题卡片规则见 §2.6。以下仅补充贯穿 API 与报告的技术术语：
...
| v1.25 | 2026-08-25 | 明确需求与技术设计的职责边界；上线定义统一引用上线条件；精简重复术语 |
